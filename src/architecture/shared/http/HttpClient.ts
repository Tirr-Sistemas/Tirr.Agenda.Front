/**
 * @description Resposta HTTP independente de biblioteca, contendo status e corpo tipado.
 */
export interface HttpResponse<T> { readonly status: number; readonly data: T; }
/**
 * @description Contrato mínimo de cliente HTTP para adaptadores que não dependem do Axios.
 */
