/** Estados possíveis de um estabelecimento. */
export type BusinessStatus = "active" | "suspended" | "inactive";
/** Propriedades necessárias para reconstruir a entidade de estabelecimento. */
...
/** Entidade raiz que normaliza o slug e protege os dados obrigatórios da empresa. */
