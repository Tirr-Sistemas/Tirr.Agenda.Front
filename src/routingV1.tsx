...
import AdminNavigationV1 from "@/page/administrator/AdminNavigationV1";
import TopBarV1 from "@/page/administrator/TopBarV1";
import PublicSchedulerPage from "@/page/scheduler/PublicSchedulerPage";
...
const CatalogPage = lazy(() => import("@/page/administrator/CatalogPage"));
const CustomersPageV1 = lazy(() => import("@/page/administrator/CustomersPageV1"));
const SettingsPage = lazy(() => import("@/page/administrator/SettingsPageV2"));
const TeamPage = lazy(() => import("@/page/administrator/TeamPageV2"));
